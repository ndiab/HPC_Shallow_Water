...
void share_lines(void){
  ...
  if(rang<NP-1){
    ...
    MPI_Send(&hFil[(size_x-2)*size_y],size_y,MPI_DOUBLE,rang+1,TAG_hFil_H_t0,MPI_COMM_WORLD);
    MPI_Send(&uFil[(size_x-2)*size_y],size_y,MPI_DOUBLE,rang+1,TAG_uFil_H_t0,MPI_COMM_WORLD);
    MPI_Send(&vFil[(size_x-2)*size_y],size_y,MPI_DOUBLE,rang+1,TAG_vFil_H_t0,MPI_COMM_WORLD);
    MPI_Send(&hPhy[(size_x-2)*size_y],size_y,MPI_DOUBLE,rang+1,TAG_hPhy_H_t0,MPI_COMM_WORLD);
    MPI_Send(&uPhy[(size_x-2)*size_y],size_y,MPI_DOUBLE,rang+1,TAG_uPhy_H_t0,MPI_COMM_WORLD);
    MPI_Send(&vPhy[(size_x-2)*size_y],size_y,MPI_DOUBLE,rang+1,TAG_vPhy_H_t0,MPI_COMM_WORLD);
    ...
    MPI_Recv(&hFil[(size_y*(rang==0?size_x_base:size_x))+(size_x-1)*size_y],size_y,MPI_DOUBLE,rang+1,TAG_hFil_L_t1,MPI_COMM_WORLD,&status);
    MPI_Recv(&uFil[(size_y*(rang==0?size_x_base:size_x))+(size_x-1)*size_y],size_y,MPI_DOUBLE,rang+1,TAG_uFil_L_t1,MPI_COMM_WORLD,&status);
    MPI_Recv(&vFil[(size_y*(rang==0?size_x_base:size_x))+(size_x-1)*size_y],size_y,MPI_DOUBLE,rang+1,TAG_vFil_L_t1,MPI_COMM_WORLD,&status);
    MPI_Recv(&hPhy[(size_y*(rang==0?size_x_base:size_x))+(size_x-1)*size_y],size_y,MPI_DOUBLE,rang+1,TAG_hPhy_L_t1,MPI_COMM_WORLD,&status);
    MPI_Recv(&uPhy[(size_y*(rang==0?size_x_base:size_x))+(size_x-1)*size_y],size_y,MPI_DOUBLE,rang+1,TAG_uPhy_L_t1,MPI_COMM_WORLD,&status);
    MPI_Recv(&vPhy[(size_y*(rang==0?size_x_base:size_x))+(size_x-1)*size_y],size_y,MPI_DOUBLE,rang+1,TAG_vPhy_L_t1,MPI_COMM_WORLD,&status);
  }
